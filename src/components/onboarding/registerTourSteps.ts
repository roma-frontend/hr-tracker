...
export const registerTourSteps: TourStep[] = [
  ...
  },
  {
    ...
    description: "Система автоматически проверит ваш email и предложит исправления, если найдет опечатки!",
    placement: "bottom",
    highlight: true,
  },
  {
  ...
  },
  {
    ...
    description: "Следите за цветом: 🔴 Слабый → 🟠 Средний → 🟡 Хороший → 🟢 Надежный → 💎 Превосходный",
    placement: "bottom",
    highlight: true,
  },
  {
  ...
  },
  {
    ...
    description: "Все умные помощники готовы помочь вам! Заполните форму и присоединяйтесь к команде! 🎊",
    placement: "center",
    highlight: false,
  },
];
